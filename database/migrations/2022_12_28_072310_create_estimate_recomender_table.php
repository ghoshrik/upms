...
class CreateEstimateRecomenderTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('estimate_recomender', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('estimate_recomender');
    }
}
