...
class RecomenderVerifiedTable extends DataTableComponent
{
    ...
    public function builder(): Builder
    {
        return Esrecommender::query()
            ...
            ->where('estimate_masters.status','!=',4)
            ->where('estimate_masters.status','!=',8);
            // ->where([['estimate_masters.status','=',2],['estimate_masters.is_verified','=',1]]);
        // ->groupBy('estimate_recomender.estimate_id');
    }
}
