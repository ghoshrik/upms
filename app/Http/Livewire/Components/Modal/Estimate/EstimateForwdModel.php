...
class EstimateForwdModel extends Component
{
    use Actions;
    ...
    public function fwdModalOpen($forwdEstimateDeatils)
    {
        ...
        $this->fwdRequestFrom = $forwdEstimateDeatils['forwd_from'];
...
// dd($userAccess_id->parent_id);
        ...
        return view('livewire.components.modal.estimate.estimate-forwd-model');
    }
