    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('link')
            ->addColumn('link_type')
            ->addColumn('permissions_roles',function(Menu $menu){
		return "<span class='text-wrap'>".$menu->permissions_roles."</span>";
	     })
            ->addColumn('permission_or_role',function(Menu $menu){
		return "<span class='text-wrap'>".$menu->permission_or_role."</span>";
	    });
    }
