...
class CompositSor extends Model
{
    ...
    protected $fillable =
        [
        "dept_category_id", "sor_itemno_parent_id", "sor_itemno_child", "description", "unit_id", "rate", "sor_itemno_child_id","sor_itemno_parent_index","col_position","created_by","updated_by"
    ];
