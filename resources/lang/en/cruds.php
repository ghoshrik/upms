...
return [
    ...
    'user-management' => [
        ...
        'fields' => [
            ...
            'office_name' => 'Office Name',
            'office_lvl' => 'Select Office Level',
            'username' => 'Login Id',
            'ehrms_id' => 'eHRMS',
            'mobile' => 'Mobile No',
    ...
    'abstract' => [
        'title' => 'Abstracts Estimates',
        'title_singular' => 'Abstract Estimates',
        'create_msg' => 'New Estimate Abstracts Created',
        'fields' => [
            'id' => 'ID',
            'id_helper' => 'Sl.No',
            'project_desc' => 'Project Title',
            'dept_category' => 'Department Category',
            'category_item' => 'Category Item',
            'category_works' => 'Category of Works',
    ...
    'taxes' => [
        'title' => 'Taxes Masters',
        'title_singular' => 'Tax Masters',
        'create_msg' => 'New Tax Added',
        'fields' => [
            'id' => 'ID',
            'id_helper' => 'Sl.No',
            'category' => 'Department Category',
            't_name' => 'Tax Name',
            't_ptr' => 'Tax Percentage',
            'status' => 'Status',
            'actions' => 'Actions'
        ],
    ],
