<ul class="navbar-nav iq-main-menu" id="sidebar">
    ...
    @else
    @php
    $side_menu = \App\Models\MenuPermission::join('menus', 'menu_permissions.menu_id', '=',
    'menus.id')->where('parent_id', '=', '0')
    ->where('userType_id', '=', Auth::user()->user_type)
    ->get();
    $accessPermission = \App\Models\AccessMaster::join('access_types', 'access_masters.access_type_id', '=',
    'access_types.id')
