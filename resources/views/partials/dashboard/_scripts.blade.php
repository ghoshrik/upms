...
<!-- Update version-->
<script type="text/javascript" src="{{ asset('js/jspdf/jspdf.umd.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/jspdf/jspdf.plugin.autotable.min.js') }}"></script>

<script type="text/javascript" src="{{ asset('js/jsPdf2.4.1/jspdf.umd.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/jsPdf2.4.1/jspdf.plugin.autotable.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('js/sheet/xlsx.full.min.js') }}"></script>
