    ...
    <x-form-section submit='store'>
        <x-slot name='form'>
            <div class="row">
                ...
                <div class="col-md-3 col-lg-3 col-sm-3">
                    <x-input label="{{ trans('cruds.tenders.fields.tender_id') }}" wire:model.defer="InputStoreData.tenderNo" placeholder="{{ trans('cruds.tenders.fields.tender_id') }}"/>
                ...
                <div class="col-md-6 col-lg-6 col-sm-3">
                    <x-input label="{{ trans('cruds.tenders.fields.title') }}" wire:model.defer="InputStoreData.tenderTitle" placeholder="{{ trans('cruds.tenders.fields.title') }}"/>
                </div>

                <div class="col-md-3 col-lg-3 col-sm-3">
                    <x-datetime-picker without-time
                        label="{{ trans('cruds.tenders.fields.date_of_pub') }}"
                ...
                <div class="col-md-3 col-lg-3 col-sm-3 mt-2">
                    <x-datetime-picker without-time
                        label="{{ trans('cruds.tenders.fields.date_of_close') }}"
                        placeholder="{{ trans('cruds.tenders.fields.date_of_close') }}"
                        wire:model.defer="InputStoreData.closeDate"
                    />
                </div>
                <div class="col-md-3 col-lg-3 col-sm-3 mt-2">
                    <x-input label="{{ trans('cruds.tenders.fields.num_bider') }}" wire:model.defer="InputStoreData.BiderNo" placeholder="{{ trans('cruds.tenders.fields.num_bider') }}"/>
                </div>

                <div class="col-md-3 col-lg-3 col-sm-3 mt-2">
                    <x-select
                        label="Select {{ trans('cruds.tenders.fields.category') }}"
                        placeholder="Select {{ trans('cruds.tenders.fields.category') }}"
