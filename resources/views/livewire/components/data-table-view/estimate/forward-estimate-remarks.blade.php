 @php
    ...
    //      ->first();
     $getRemarks = App\Models\EstimateUserAssignRecord::where('user_id', Auth::user()->id)->where('estimate_user_type',1)->orWhere('estimate_user_type',2)->where('estimate_id',$value)->first();
    //  print_r('<pre>');
    //  print_r($getRemarks);
    //  print_r('</pre>');
