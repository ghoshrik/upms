                                            ...
                                            <div class="card card-body">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody class="metatable">
                                                        ...
                                                        $data = json_decode($view['rate_analysis_data'], true);
                                                        if (isset($data['metadata'])) {
                                                           ...
                                                           // dd($metadataArray);
                                                            foreach ($metadataArray as $index => $metadata) {
                                                                ?>
                                                        <tr>
                                                            <td style="text-align:center;">{{$alphabet}}<?php echo $index + 1; ?></td>
                                                        ...
                                                        <tr class="collapse"
                                                            ...
                                                            <td colspan="5">
                                                                ...
                                                                $ruledata = json_decode($view['rate_analysis_data'], true);
