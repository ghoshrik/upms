<div>
    <div class="card">
        ...
        <div class="card-body" wire:loading.delay.shorter.class="loading">
            <div class="row">
                <div class="col-md-3 col-sm-3 col-lg-3">
                    <div class="form-group">
                        <x-select label="Department Category" placeholder="Select Department Category"
                            wire:model.defer='storeItem.dept_category_id' x-on:select="$wire.getDeptCategoryTable()">
                ...
                <div class="col-md-3 col-sm-3 col-lg-3">
                    <div class="form-group">
                        <x-select label="Table No" placeholder="Select Table No" wire:model.defer="storeItem.table_no"
                            x-on:select="$wire.getPageNoTableWise()">
                ...
                <div class="col-md-3 col-sm-3 col-lg-3">
                    <div class="form-group">
                        <x-select label="Page No" placeholder="Select Page No" wire:model.defer="storeItem.page_no"
                            x-on:select="$wire.getDynamicSor('parent')">
                ...
                <div class="col-md-3 col-sm-3 col-lg-3">
                    <div class="form-group">
                        <x-input label="Item No" placeholder="Item No" wire:model.defer="storeItem.item_no" readonly />
                    </div>
                </div>
            </div>
            @if ($storeItem['item_no'] != '')
                @foreach ($inputsData as $key => $input)
                    <div class="row mutipal-add-row">
                        <div class="col">
                            <div class="form-group">
                                {{-- <x-select label="Select Option" placeholder="Select"
                                    wire:model.defer="inputsData.{{ $key }}.table"
                                    x-on:select="$wire.getCategory({{ $key }})">
                                    @foreach ($fetchDropDownData['types'] as $type)
                                        <x-select.option wire:key="{{ $type['id'] }}" label="{{ $type['name'] }}"
                                            value="{{ $type['id'] }}" />
                                    @endforeach
                                </x-select> --}}
                                <label for="typeSelect">Select Type</label>
                                <select wire:model.defer="inputsData.{{ $key }}.table" wire:change='getCategory({{ $key }})' id="" class="form-select" aria-label="Select Type">
                        ...
                        @if ($inputsData[$key]['table'] == 0 || $inputsData[$key]['table'] == 1)
                            <div class="col">
                                <div class="form-group">
                                    <x-select label="Table No" placeholder="Select Table No"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <x-select label="Page No" placeholder="Select Page No"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <x-select label="Unit" placeholder="Select Unit" wire:model.defer="inputsData.{{ $key }}.unit_id" >
