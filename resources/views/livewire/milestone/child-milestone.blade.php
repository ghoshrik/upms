<li>
    <div class="treeview__level" data-level="S">
        ...
        <div class="treeview__level-btns">
            ...
            <div class="btn btn-default btn-sm level-add" wire:click='ApprovedMilestone({{$child_milestone->milestone_name}})'
                wire:key='{{ $child_milestone->id}}'>{{$child_milestone->Is_achived}}</div>
