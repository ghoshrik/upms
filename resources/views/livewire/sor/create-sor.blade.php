                        ...
                        <div class="row mutipal-add-row">
                            <div class="col-md-11 col-sm-6 col-lg-11">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <x-input wire:key='unit.{{ $key }}' label="{{ trans('cruds.sor.fields.unit') }}"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <x-input wire:key='cost.{{ $key }}' label="{{ trans('cruds.sor.fields.cost') }}"
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <x-select wire:key="version.{{ $key }}"
                                                ...
                                                wire:model.defer="inputsData.{{ $key }}.version"  :options="[
