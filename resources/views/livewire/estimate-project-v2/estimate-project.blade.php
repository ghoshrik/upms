        ...
        <div wire:loading.delay.long.class="loading">
            @if ($isFromOpen && $openedFormType == 'create')
                <div x-transition.duration.900ms>
                    <livewire:estimate-project-v2.create-estimate-project />
                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        {{-- <livewire:estimate-project.data-table.estimate-project-table
                                            :wire:key="$updateDataTableTracker" /> --}}
                                        <livewire:estimate-project-v2.data-table.estimate-project-table
                                            :wire:key="$updateDataTableTracker" />
                                    </div>
                                </div>
...
<livewire:components.modal.estimate-v2.estimate-view-modal />
