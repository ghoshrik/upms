            ...
            <div class="card">
                ...
                <div wire:loading.delay.longest.class="loading" class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <x-input wire:model="newUserData.emp_id" label="Employee ID" placeholder="Enter HRMS ID" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <x-input wire:model="newUserData.username" label="Username" placeholder="Enter Employee Username" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
