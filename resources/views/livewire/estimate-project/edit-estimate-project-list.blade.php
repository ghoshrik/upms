            ...
            <div class="card overflow-hidden">
                <div class="card-header d-flex justify-content-between flex-wrap">
                    <div class="header-title">
                        <h4 class="card-title mb-2">Edit Estimate Project List</h4>
                    </div>
                </div>
                <div>
                    <div class="row m-2">
                                ...
                                @foreach ($allAddedEstimatesData as $key => $addedEstimate)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            @if ($addedEstimate['row_index'] == null && $addedEstimate['estimate_no'] == 0)
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6"><button type="submit" wire:click='store({{ $updateEstimateprojectId }})'
