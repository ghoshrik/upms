                            ...
                            @if (!empty($estimateData))
                                @if ($estimateData['item_name'] == 'SOR')
                                    <div class="row" style="transition: all 2s ease-out">
                                                ...
                                                <x-select wire:key="volume" label="Volume" placeholder="Select Volume"
                                                    ...
                                                    @isset($fatchDropdownData['volumes'])
                                                        @foreach ($fatchDropdownData['volumes'] as $volume)
                                                            <x-select.option
                                                                label="{{ getVolumeName($volume['volume_no']) }}"
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <x-select wire:key="page_no" label="Page No"
                                                    placeholder="Select Page No" wire:model.defer="estimateData.id"
                                ...
                                @if ($estimateData['item_name'] == 'Other')
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                <x-input wire:key="other_name"
                                                    wire:model.defer="estimateData.other_name" label="Item Name"
                                ...
                                @if ($estimateData['item_name'] == 'Rate')
                                    <div class="row">
                                        ...
                                        @else
                                            <div class="col">
                                                <div class="form-group">
                                                    <x-select wire:key="qty_a_value"
                                                        label="{{ __('Select Quantity') }}"
