    ...
    <div x-show="!formOpen && !editFormOpen" >
        <div class="row">
                ...
                <div class="row row-cols-1">
                    <div class="d-slider1 overflow-hidden ">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <li class="swiper-slide card card-tab card-slide {{ $this->selectedTab==2 ?'active':'' }}" wire:click='verifiedData()'>
                                    <div class="card-body"  wire:ignore>
                                        <div class="progress-widget">
                                            <div id="circle-progress-02"
                                                class="circle-progress-01 circle-progress circle-progress-info text-center"
                                                data-min-value="0" data-max-value="100" data-value="{{ $counterData['verifiedDataCount'] }}"
                                                data-type="percent">
                                            ...
                                            <div class="progress-detail">
                                                ...
                                                <h4 class="counter" style="visibility: visible;">{{ $counterData['verifiedDataCount'] }}</h4>
                                            </div>
                                        </div>
                                    </div>
                                </li>
            ...
            <div class="col-md-12 col-lg-12 col-sm-3">
                ...
                <div class="card">
                    <div class="card-body">
                        <livewire:estimate-recomender.datatable :wire:key="$updateDataTableTracker" />
                    </div>
                </div>
