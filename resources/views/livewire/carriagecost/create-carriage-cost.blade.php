                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-sm-3">
                            <div class="form-group">
                                ...
                                <x-textarea wire:key='description' wire:model.defer="InputText.Desc" rows="2"
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-3">
                            <div class="form-group">
                                <x-input wire:model="InputText.distance" label="Distance" placeholder="enter distance"
                                    wire:key='distance' />
                            </div>
                        </div>
                        <div class="col-md-3 col-lg-3 col-sm-3">
                            <div class="form-group">
                                <x-select wire:key="unit" label="Unit" placeholder="Select Unit"
                                    wire:model.defer="InputText.unit" :options="[['name' => 'KM', 'id' => 1]]" option-label="name" option-value="id" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-3 col-lg-4">
                            <div class="form-group">
                                <x-select wire:key="category"
                                    ...
                                    wire:model.defer="estimateData.dept_category_id" x-on:select="$wire.getVersion()">
